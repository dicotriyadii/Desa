            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                    ...
                    <textarea name="visi" class="form-control" style="width:200%;height:300px;">
                    <?= $d['visi'];?>
                    </textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea name="misi" class="form-control" style="width:200%;height:300px;">
                    <?= $d['misi'];?>
                    </textarea>
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">Keterangan<span style="color:red;">*</span></span></label>
                    <textarea name="keterangan" class="form-control" style="width:200%;height:300px;"><?= $d['keterangan'];?></textarea>
                </div>
                <!-- /.form-group -->
              </div>
            </div>
