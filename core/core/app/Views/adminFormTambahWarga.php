    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                    <label for="exampleInputEmail1">Upload data warga dari exel (.csv)</label><br>
          ...
          <a href="<?= base_url()?>/downloadFormatCSV"><div>Contoh Format CSV / EXEL</div></a><br>
        </div>
        <div class="card card-default">
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="namaWarga" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Nama Lengkap" required> 
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="RT" class="form-control" id="exampleInputEmail1" placeholder="Masukkan RT" required>
                </div>
                <div class="form-group">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="tanggalLahir" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Tanggal Laghir" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="RW" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Desa / Kelurahan" required>
                </div>
                <div class="form-group">
