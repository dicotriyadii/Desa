...
<head>
    ...
    <title>Sistem Informasi Desa Mulio Rejo</title>
                ...
                <div class="col-md-8">
                    ...
                    <article class="post post-type-image single-post row">
                        <div class="row featured-contents">
                            <a href="single.html"><img src="../../artikel/<?=$dataArtikel[0]['gambarArtikel']?>" alt=""></a>
                        </div>
                        <div class="row article-body">
                            <h3 class="post-title"><a href="single.html"><?=$dataArtikel[0]['judulArtikel']?></a></h3>
                            <ul class="post-meta nav">
                                <li class="post-date"><i class="fa fa-calendar-o"></i> <a href="#"><?=$dataArtikel[0]['tanggalArtikel']?></a></li>       
                                <li class="posted-by"><i class="fa fa-user"></i>posted by: <a href="#"><?=$dataArtikel[0]['authorArtikel']?></a></li>
                            </ul>
                            <div class="post-content row">
                                <p><?=$dataArtikel[0]['keterangan']?></p>
                            </div>
                        </div>
                    </article>
                </div>
