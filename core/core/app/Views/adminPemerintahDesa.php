          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-footer" style="text-align:left; margin-top:15px;background-color:white;">
                <a href="<?= base_url()?>/formAnggotaPemerintah" style="background-color:green;padding:8px 10px;border-radius:10px;color:white;">Tambah Anggota Pemerintah</a>
              </div>
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><?= $d['keterangan'] ?></td>
                    <td>
                      <a href="<?=base_url()?>/editAnggotaPemerintah/<?= $d['idAnggotaPemerintah']?>" style="color:green;">Edit</a><br>
