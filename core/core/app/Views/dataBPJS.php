...
?>    
    <section >
        <div class="container">
            <h1>Data BPJS <?= $dataDesa[0]['namaDesa']?></h1>
        </div>
    </section>
                        ...
                        <div class="row article-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    <td>1</td>
                                    <td>Memiliki BPJS</td>
                                    <td><?=$jumlahPenggunaBPJS;?></td>
                                </tr>
                                <tr>
                                    <td>2</td>
                                    <td>Tidak Memiliki BPJS</td>
                                    <td><?=$jumlahTidakPenggunaBPJS;?></td>
                                </tr>
                                </table>
                        </div>
                    </article>
    ...
    <script>
		...
		var myChart = new Chart(ctx, {
			...
			data: {
				labels: [
                    'Memiliki BPJS','Tidak Memiliki BPJS'
                ],
				datasets: [{
					label: 'Data Dusun',
					data: [
                        <?php echo '"'.$jumlahPenggunaBPJS.'"'?>,<?php echo '"'.$jumlahTidakPenggunaBPJS.'"'?>
                    ],
					backgroundColor: [
					'rgba(255, 99, 132, 1)',
					'rgba(54, 162, 235, 1)',
