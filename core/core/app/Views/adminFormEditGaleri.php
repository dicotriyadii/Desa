            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                    <label for="exampleInputEmail1">Judul Gambar<span style="color:red;">*</span></span></label>
                    <input type="text" name="judulGambar" class="form-control" id="exampleInputEmail1" value="<?= $d['namaGambar'];?>">
                    <input type="text" name="idGambar" value="<?= $d['idGaleri'];?>" hidden>
                </div>
                <div class="form-group">
