...
?>    
    <section >
        <div class="container">
            <h1>Data Bantuan Sosial <?= $dataDesa[0]['namaDesa']?></h1>
        </div>
    </section>
                    ...
                    <article class="post post-type-image single-post row">
                        ...
                        <div class="row article-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    <td>1</td>
                                    <td>Menerima Bantuan Sosial</td>
                                    <td><?=$dataPenerimaBansos;?></td>
                                </tr>
                                <tr>
                                    <td>2</td>
                                    <td>Tidak Menerima Bantuan Sosial</td>
                                    <td><?=$dataTidakPenerimaBansos;?></td>
                                </tr>
                                </table>
                        </div>
                    </article>
    ...
    <script>
		...
		var myChart = new Chart(ctx, {
			...
			data: {
				labels: [
                    'Menerima Bantuan Sosial','Tidak Menerima Bantuan Sosial'
                ],
				datasets: [{
					label: 'Data Dusun',
					data: [
                        <?php echo '"'.$dataPenerimaBansos.'"'?>,<?php echo '"'.$dataTidakPenerimaBansos.'"'?>
                    ],
					backgroundColor: [
					'rgba(255, 99, 132, 1)',
					'rgba(54, 162, 235, 1)',
