...
class Admin extends BaseController
{
    ...
    public function dashboard()
    {
        ...
        $dataPekerjaan              = $pekerjaan->getPekerjaan();
        $dataKritikSaran            = $kritikSaran->orderBy('idKritikSaran','DESC')->getKritikSaran();
        ...
        $jumlahKartuKeluarga        = $warga->getTotalKartuKeluarga();
        ...
        return view('adminDashboard',compact('jumlahBerpendidikan','jumlahTidakBerpendidikan','jumlahBekerja','jumlahTidakBekerja','dataSeluruhWarga','dataLakiLaki','dataPerempuan','dataMeninggal','jumlahBPJS','dataPenerimaBansos','jumlahPermohonanSelesai','jumlahPermohonanPending','jumlahPermohonanProses','jumlahPermohonanDitolak','dataKritikSaran','jumlahKartuKeluarga'));
    }
    ...
    public function potensiDesa()
    {
        ...
        $data        = $potensi->getPotensi();
        return view('adminPotensiDesa',compact('data'));
    }
