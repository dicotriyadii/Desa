...
class ProsesTambahProfilKeamanan extends ResourceController
{
    use ResponseTrait;
    ...
    public function create()
    {
        ...
        $dataLog = [
            ...
            'keterangan'    => 'Penambahan Profil Keamanan',
        ];
        $log->insert($dataLog);
        $ses_data = [
            'statusTambah'  => "Berhasil",
            'keterangan'    => "profil Keamanan berhasil di tambah"
        ];
