...
class Menu extends BaseController
{
    ...
    public function bpd()
    {
        ...
        $dataKontak     = $kontak->getKontak();  
        $tema           = $tema->getTema();
        $dataBPD        = $bpd->getStrukturBPD(); 
        return view('bpd',compact('dataKontak','tema','dataBPD','dataDesa','dataBerita'));
    }
    public function bumdes()
    {
        $kontak         = new Model_kontak();  
        $tema           = new Model_tema();  
        $bumdes         = new Model_struktur_bumdes();
        $desa           = new Model_desa();  
        $berita         = new Model_berita();
        $dataBerita     = $berita->where('status','Sudah Validasi')->orderBy('tanggalBerita','desc')->findAll(4);
        $dataDesa       = $desa->getDesa();
        $dataKontak     = $kontak->getKontak();  
        $tema           = $tema->getTema();
        $dataBumdes     = $bumdes->getStrukturBumdes(); 
        return view('bumdes',compact('dataKontak','tema','dataBumdes','dataDesa','dataBerita'));
    }
    ...
    public function dataJenisKelamin()
    {
        ...
        $warga              = new Model_warga();
        //proses
        $jumlahJenisKelaminSeluruh     = $jenisKelamin->countAll();
        $dataJenisKelamin       = $jenisKelamin->getJenisKelamin();
        for($i=0;$i<$jumlahJenisKelaminSeluruh;$i++){
    ...
    public function galeri()
    {
        ...
        $dataDesa       = $desa->getDesa();
        $dataKontak     = $kontak->getKontak();    
        $dataGaleri     = $galeri->where('gambar != ','video')->findAll();
        $tema           = $tema->getTema();
    ...
    public function video()
    {
        ...
        $dataGaleri     = $galeri->where('gambar','video')->findAll();
        $tema           = $tema->getTema();
        return view('galeriVideo',compact('dataKontak','tema','dataGaleri','dataDesa','dataBerita'));
    }
