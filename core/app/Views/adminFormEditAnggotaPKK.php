  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Perubahan data Anggota PKK</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <!-- /.card-header -->
          <div class="card-body">
          <form class="form-horizontal" action="../ProsesEditAnggotaPKK" method="POST"  enctype="multipart/form-data">
            <?php
            foreach($data as $d){
            ?>
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="idUser" value="<?= $d['idAnggotaPKK'];?>" hidden>
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">Keterangan<span style="color:red;">*</span></label>
                    <textarea name="keteranganAnggotaPKK" class="form-control" style="width:100%;height:150px;"><?= $d['keterangan']?></textarea>
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
