			...
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-4">
					<div class="login-wrap p-0">
		      	        <h3 class="mb-4 text-center"><b>Aplikasi Pelayanan Desa</b></h3>
		      	        <form action="ProsesLoginWarga" class="signin-form" method="POST">
		      		    <div class="form-group">
		      			    <input type="text" name="nik" class="form-control" placeholder="Masukkan Nomor Induk Kependudukan" required>
		      		    </div>
						<div class="form-group">
                        ...
                        <div class="form-group d-md-flex">
                            ...
                            <div class="w-50 text-md-right">
                                <a href="<?=base_url()?>/loginAdmin" style="color: #fff">*Masuk Sebagai Admin</a>
								<a href=""data-toggle="modal" data-target="#notifikasi" style="color: #fff">*Lupa Password</a>
							</div>
	                    </div>
	                    </form>
		            </div>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<h4 style="color:red;">Silahkan Hubungi Admin Website Desa</h4>
						</div>
					</div>
				</div>
			</div>
