...
<div class="modal fade" id="modaledit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <?= form_open('kriteriaRumah/proses_edit', ['class' => 'formedit']) ?>
            <?= csrf_field(); ?>
            <div class="modal-body">
                <div class="form-group">
                    <label>Kriteria Rumah</label>
                    <input type="hidden" class="form-control" id="id" name="id" value="<?= $list['id'] ?>">
                    <input type="text" class="form-control" id="kriteria_rumah" name="kriteria_rumah" value="<?= $list['jenis_kriteria_rumah'] ?>">
