...
<div class="modal fade" id="modaledit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <?= form_open('catatanKeluarga/proses_edit', ['class' => 'formedit']) ?>
            <?= csrf_field(); ?>
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="tgl" name="tgl" value="<?= $list['tgl'] ?>">
                    ...
                    <select name="nik" id="nik" class="form-control">
                        ...
                        <?php foreach ($nik as $n) : ?>
                            <?php if ($n['dusun'] == $dusun) : ?>
                                <option value="<?= $n['nomorIndukKependudukan'] ?>" <?php if ($n['nomorIndukKependudukan'] == $list['nik']) echo "selected"; ?>><?= $n['namaWarga'] ?> , <?= $n['jenisKelamin'] ?> , <?= $n['alamat'] ?></option>
                            <?php endif; ?>
                        <?php endforeach; ?>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="jmlh_kk" name="jmlh_kk" value="<?= $list['jumlah_kk'] ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="jmlh_total_laki_laki" name="jmlh_total_laki_laki" value="<?= $list['jml_laki_laki'] ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="jmlh_total_perempuan" name="jmlh_total_perempuan" value="<?= $list['jml_perempuan'] ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="jmlh_balita_laki_laki" name="jmlh_balita_laki_laki" value="<?= $list['balita_laki_laki'] ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="jmlh_balita_perempuan" name="jmlh_balita_perempuan" value="<?= $list['balita_perempuan'] ?>">
                ...
                <div class="form-group">
                    <label>PUS</label>
                    <input type="number" class="form-control" id="pus" name="pus" value="<?= $list['pus'] ?>">
                ...
                <div class="form-group">
                    <label>WUS</label>
                    <input type="number" class="form-control" id="wus" name="wus" value="<?= $list['wus'] ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="jmlh_ibu_hamil" name="jmlh_ibu_hamil" value="<?= $list['ibu_hamil'] ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="jlmh_ibu_menyusui" name="jlmh_ibu_menyusui" value="<?= $list['ibu_menyusui'] ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="jmlh_lansia" name="jmlh_lansia" value="<?= $list['lansia'] ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="jmlh_3_buta" name="jmlh_3_buta" value="<?= $list['3_buta'] ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="jmlh_jamban_keluarga" name="jmlh_jamban_keluarga" value="<?= $list['jml_jamban_keluarga'] ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="berkebutuhan_khusus" name="berkebutuhan_khusus" value="<?= $list['berkebutuhan_khusus'] ?>">
                ...
                <div class="form-group">
                    ...
                    <select name="kriteria_rumah" id="kriteria_rumah" class="form-control">
                        ...
                        <?php foreach ($kriteria_rumah as $kr) : ?>
                            <option value="<?= $kr['id'] ?>" <?php if ($kr['id'] == $list['kriteria_rumah']) echo "selected"; ?>><?= $kr['jenis_kriteria_rumah'] ?></option>
                        <?php endforeach; ?>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select name="sumber_air" id="sumber_air" class="form-control">
                        ...
                        <?php foreach ($sumber_air as $sa) : ?>
                            <option value="<?= $sa['id'] ?>" <?php if ($sa['id']  == $list['sumber_air']) echo "selected"; ?>><?= $sa['jenis_sumber_air'] ?></option>
                        <?php endforeach; ?>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select name="tempat_sampah" id="tempat_sampah" class="form-control">
                        ...
                        <?php foreach ($tempat_sampah as $ts) : ?>
                            <option value="<?= $ts['id'] ?>" <?php if ($ts['id']   == $list['tempat_sampah']) echo "selected"; ?>><?= $ts['jenis_tempat_sampah'] ?></option>
                        <?php endforeach; ?>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select name="jenis_kegiatan_id" id="jenis_kegiatan_id" class="form-control">
                        ...
                        <?php foreach ($jenis_kegiatan as $jk) : ?>
                            <option value="<?= $jk['id'] ?>" <?php if ($jk['id']  == $list['jenis_kegiatan_id']) echo "selected"; ?>><?= $jk['jenis_kegiatan'] ?></option>
                        <?php endforeach; ?>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nama_kegiatan" name="nama_kegiatan" value="<?= $list['nama_kegiatan'] ?>">
                ...
                <div class=" form-group">
                    ...
                    <select name="makanan_pokok" id="makanan_pokok" class="form-control">
                        ...
                        <?php foreach ($makanan_pokok as $mp) : ?>
                            <option value="<?= $mp['id'] ?>" <?php if ($mp['id']  == $list['makanan_pokok']) echo "selected"; ?>><?= $mp['makanan_pokok'] ?></option>
                        <?php endforeach; ?>
                    </select>
