...
<div class="modal fade" id="modaledit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <?= form_open('sumberAirKeluarga/proses_edit', ['class' => 'formedit']) ?>
            <?= csrf_field(); ?>
            <div class="modal-body">
                <div class="form-group">
                    <label>Jenis Sumber Air</label>
                    <input type="hidden" class="form-control" id="id" name="id" value="<?= $list['id'] ?>">
                    <input type="text" class="form-control" id="jenis_sumber_air" name="jenis_sumber_air" value="<?= $list['jenis_sumber_air'] ?>">
