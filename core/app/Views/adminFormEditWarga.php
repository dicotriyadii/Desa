          ...
          <form class="form-horizontal" action="../ProsesEditWarga" method="POST"  enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                    <label for="exampleInputEmail1">Tempat Lahir <span style="color:red;">*</span></span></label>
                    <input type="text" name="tempatLahir" class="form-control" id="exampleInputEmail1" value=<?=$d['tempatLahir']?>>
                </div>
                <div class="form-group">
                    <label>Agama</label>
