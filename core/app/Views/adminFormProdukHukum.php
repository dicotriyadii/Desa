    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <!-- /.card-header -->
          <div class="card-body">
          <form class="form-horizontal" action="ProsesProdukHukum" method="POST"  enctype="multipart/form-data">
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                    <label for="exampleInputEmail1">Produk Hukum<span style="color:red;">*</span></span></label>
                    <input type="text" name="produkHukum" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Nama Produk Hukum">
                </div>
                <div class="form-group">
