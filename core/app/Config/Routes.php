...
$routes->get('/bpd', 'Menu::bpd');
$routes->get('/bumdes', 'Menu::bumdes');
...
$routes->get('/adminPotensiDesa', 'Admin::potensiDesa');
...
$routes->get('/hapusAnggotaBPD/(:any)', 'ProsesAnggotaBPD::hapusAnggotaBPD/$1');
...
$routes->get('/hapusPotensi/(:any)', 'CProsesPotensi::hapusPotensi/$1');
...
$routes->resource('ProsesEditAnggotaBPD');
$routes->resource('ProsesEditAnggotaBumdes');
...
$routes->resource('ProsesAnggotaBPD');
$routes->resource('ProsesAnggotaBumdes');
...
$routes->resource('ProsesGaleriVideo');
...
$routes->resource('CProsesPotensi');
$routes->resource('CProsesEditPotensi');
