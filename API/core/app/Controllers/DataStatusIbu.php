...
class DataStatusibu extends ResourceController
{ 
    // create a product
    ...
    {           
        ...
        if($cekTokenWarga == null){
            ...
            // Proses Data
            $dataMeninggal = $data->getStatusIbuBayiMeninggal();
            $dataLahir = $data->getStatusIbuBayiLahir();
            return $this->respond($dataLahir);    
        }  
    }
}